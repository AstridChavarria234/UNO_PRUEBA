...
namespace PARCIAL.Pages
{
	...
	partial class CancellationPage
	{
		...
		/// </remarks>
		public CancellationPage(IntPtr javaReference, global::Android.Runtime.JniHandleOwnership transfer) : base (javaReference, transfer) { }
#endif
#if __IOS__ || __MACOS__
		/// <summary>
		/// Native constructor, do not use explicitly.
		...
		/// objects that may have been collected in the managed world.
		/// </remarks>
		public CancellationPage(IntPtr handle) : base (handle) { }
#endif
	}
}
