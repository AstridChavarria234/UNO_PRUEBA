...
namespace PARCIAL.Pages
{
	...
	partial class QuestionPage
	{
		...
		/// </remarks>
		public QuestionPage(IntPtr javaReference, global::Android.Runtime.JniHandleOwnership transfer) : base (javaReference, transfer) { }
#endif
#if __IOS__ || __MACOS__
		/// <summary>
		/// Native constructor, do not use explicitly.
		...
		/// objects that may have been collected in the managed world.
		/// </remarks>
		public QuestionPage(IntPtr handle) : base (handle) { }
#endif
	}
}
