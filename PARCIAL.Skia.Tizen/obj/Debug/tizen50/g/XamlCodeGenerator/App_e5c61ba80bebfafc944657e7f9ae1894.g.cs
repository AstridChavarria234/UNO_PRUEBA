...
namespace PARCIAL
{
	...
	public partial class App : Windows.UI.Xaml.Application
	{
		private void InitializeComponent()
		{
			...
			.Apply((c0 => 
			{
				// Source C:\Projects\PARCIAL\PARCIAL.Shared\App.xaml (Line 1:2)
			...
			global::PARCIAL.Skia.Tizen.GlobalStaticResources.Initialize();
			global::PARCIAL.Skia.Tizen.GlobalStaticResources.RegisterResourceDictionariesBySourceLocal();
			global::Uno.UI.DataBinding.BindableMetadata.Provider = new global::PARCIAL.Skia.Tizen.BindableMetadataProvider();
			#if __ANDROID__
			global::Uno.Helpers.DrawableHelper.Drawables = typeof(global::PARCIAL.Skia.Tizen.Resource.Drawable);
			#endif
			Resources = 
			...
			;
			// Source ..\..\..\..\..\..\..\PARCIAL.Shared\App.xaml (Line 1:2)
		}
	}
}
namespace PARCIAL.Skia.Tizen
{
	static class App_e5c61ba80bebfafc944657e7f9ae1894XamlApplyExtensions
	{
	}
}
